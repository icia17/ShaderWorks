...
Shader "Shader paredes lava"
{
	Properties
	{
		...
		_EmmisionStrength1("Emmision Strength", Float) = 0.2
	...
	SubShader
	{
		...
		uniform float _EmmisionStrength1;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float4 temp_output_6_0 = ( _Color1 * ( 1.0 - i.uv_texcoord.y ) );
			o.Albedo = ( tex2D( _Texture1, i.uv_texcoord ) * temp_output_6_0 ).rgb;
			o.Emission = ( temp_output_6_0 * _EmmisionStrength1 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
486;73;811;778;1089.086;364.2745;1;False;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-886.0468,-215.9575;Inherit;True;Property;_Texture1;Texture 0;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.OneMinusNode;3;-683.3765,215.8367;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-744.3867,9.300056;Inherit;False;Property;_Color1;Color 0;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-626.8472,-207.9573;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-408.4913,294.4453;Inherit;False;Property;_EmmisionStrength1;Emmision Strength;2;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EDAE5BDAF06F7B61C25DEA12A7BFCA69D4094ACF