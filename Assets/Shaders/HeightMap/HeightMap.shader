...
Shader "HeightMap"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			v.vertex.xyz += ( tex2Dlod( _Texture0, float4( uv_TexCoord25, 0, 0.0) ) * float4(0,1,0,0) * _TextureHeightScale ).rgb;
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18900
562.4;73.6;607.6;484.6;728.8527;690.9853;3.495319;False;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;17;-45.98538,-154.7487;Inherit;True;Property;_Texture0;Texture 0;10;0;Create;True;0;0;0;False;0;False;None;51dabacd2b30a03498e5f4c2a4944a2e;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=F28C9642473CECAEA0E1755582A531E8C2CD3E1A