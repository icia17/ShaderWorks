...
Shader "BlackAndWhiteVignetteShader"
{
	...
	SubShader
	{
		...
		uniform float4 _CameraInputTexture1_ST;
		uniform float3 _GrayscaleLuminance1;
		uniform float _VignetteFalloff1;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_CameraInputTexture1 = i.uv_texcoord * _CameraInputTexture1_ST.xy + _CameraInputTexture1_ST.zw;
			float dotResult17 = dot( tex2D( _CameraInputTexture1, uv_CameraInputTexture1 ) , float4( _GrayscaleLuminance1 , 0.0 ) );
			float4 appendResult23 = (float4(dotResult17 , dotResult17 , dotResult17 , 0.0));
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float smoothstepResult18 = smoothstep( 0.0 , _VignetteFalloff1 , distance( ase_vertex3Pos , float3( 0,0,0 ) ));
...
/*ASEBEGIN
Version=18900
748;73;844;565;2160.376;216.756;2.02379;False;False
Node;AmplifyShaderEditor.TexturePropertyNode;8;-1458.797,-278.3598;Inherit;True;Property;_CameraInputTexture1;Camera Input Texture;0;0;Create;True;0;0;0;False;0;False;ee31f1c5bce789b40a1c6119651c1416;ee31f1c5bce789b40a1c6119651c1416;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector3Node;14;-1126.342,-26.11969;Inherit;False;Property;_GrayscaleLuminance1;Grayscale Luminance;1;0;Create;True;0;0;0;False;0;False;0.299,0.587,0.114;3,3,3;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;12;-1204.903,-278.3849;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1297.598,317.0759;Inherit;False;Property;_VignetteFalloff1;Vignette Falloff;2;0;Create;True;0;0;0;False;0;False;0;6.8;0;15;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=773A18B27FC6643512CEE47C0429A770B4DD5876