    ...
    Category
    {
        ...
        SubShader
        {
            Pass
            {
                ...
                Stencil
                {
                    Ref 100           // Reference value
                    ReadMask 255      // Read Mask
                    WriteMask 255     // Write Mask
                    Comp Equal        // Comparison: Equal
                    Pass Keep         // Pass Front: Keep
                    Fail Keep         // Fail Front: Keep
                    ZFail Keep        // ZFail Front: Keep (Default)
                }
                // -------------------------------
